...
/**restituisce la lunghezza della lista(elementi usati non dim array)*/
template< class T >
int List_vector< T >:: legginumElem()
{
    return length_;
}
/**legge il limite massimo della lista*/
template< class T >
int List_vector< T >::leggidim()
{
